...
public class matrix
{
    ...
    public static void main(/*String args[]*/)
    {
        ...
        while(true){
        System.out.println("\n\tMenu\t\n1.Addition of Two Matrices\n2.Subtraction of Two Matrices\n3.Multiplication of two matrices\n4.Transpose of a Matrix\n5.Determinant of a Matrix\n6.Solution to System of Equations\n7.EXIT");
        ...
        switch(choice)
        {
            ...
            int un=sc.nextInt();
            ob.N=un;
            double matx[][]=new double[un][un+1];
            System.out.println("Enter the Values to the System of Equation.");
            for(int i=0;i<un;i++)
            {
                for(int j=0;j<=un;j++)
                {
                    System.out.print("Enter here: ");
                    matx[i][j]=sc.nextDouble();
                }
            }
            ob.gaussianElimination(matx);
            break;
